...
import type { TextInputMaskIcon, TextInputMaskProps } from './typings';
...
export default function useStyles({
  ...
  const keyboardAppearance: TextInputMaskProps['keyboardAppearance'] = dark
    ? 'dark'
    : 'light';
  ...
  const renderIcon = useCallback(
    (Icon: TextInputMaskIcon, stroke?: string) => {
      return (
        <Icon
