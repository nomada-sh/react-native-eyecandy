...
const createColors = function () {
  ...
  return {
    button: getButtonColors({ ...variables,
      colors: partialColors.button
    }),
    text: getTextColors({ ...variables,
      colors: partialColors.text
    }),
    input: getInputColors({ ...variables,
      colors: partialColors.input
    }),
    switch: getSwitchColors({ ...variables,
      colors: partialColors.switch
    }),
    background: getBackgroundColors({ ...variables,
      colors: partialColors.background
    }),
    divider: getDividerColors({ ...variables,
