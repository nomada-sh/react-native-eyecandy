...
ActionSheets are sheets that slides up from the bottom of the screen, and present two or more choices related to an intentional user action. For example, an ActionSheet component might be used to allow a user to share content from an app.
